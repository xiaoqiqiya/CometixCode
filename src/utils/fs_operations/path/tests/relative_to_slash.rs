...
fn windows_relative_prefix_matrix_reuses_the_ordinary_strict_composition() {
    for (target, base) in [
        ...
        (
            "C:/workspace/rolldown/packages/app/index.js",
            "C:/workspace/rolldown/dist/chunks",
        ),
        ...
        (
            r"\\?\C:\workspace\packages\app\index.js",
            r"\\?\C:\workspace\dist\chunks",
        ),
        (
            r"\\?\D:\workspace\packages\app\index.js",
            r"\\?\C:\workspace\dist\chunks",
        ),
        (
        ...
        (
            r"\\?\GLOBALROOT\rolldown\packages\app\index.js",
            r"\\?\GLOBALROOT\rolldown\dist\chunks",
        ),
        (r"dist\assets\index.js", r"dist\chunks"),
