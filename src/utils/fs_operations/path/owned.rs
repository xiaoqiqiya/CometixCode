use super::normalize::normalize_owned_path_buf;
use super::slash::{path_buf_into_slash, path_buf_into_slash_lossy, try_path_buf_into_slash};
...
/// operations remain available through [`super::SugarPath`]. These methods
...
pub trait SugarPathBuf: private::Sealed {
    ...
    /// trailing-separator semantics as [`super::SugarPath::normalize`].
    ///
    /// # Examples
    ///
    /// ```ignore
    ...
    /// [`super::SugarPath::to_slash`] and may reuse the consumed path's storage.
    ///
    /// # Examples
    ///
    /// ```ignore
